...
public class VideoEncoderCore extends AndroidEncoder{
    ...
    private static final int FRAME_RATE = GlobalConfig.videoFramerate;               // 30fps
    private static final int IFRAME_INTERVAL = GlobalConfig.videoIframeInterval;           // 5 seconds between I-frames
