...
public class GPUImageView extends FrameLayout {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (mGPUImage.hasEffect() && mHandleTouchEvent) {
            return mGPUImage.onTouchEvent(event);
        }
        return super.onTouchEvent(event);
    }

    public boolean onTouchEventTwice(MotionEvent event) {
    ...
    public GPUImageFilter newCurrentFilter(GPUImageFilter filter) {
        return mGPUImage.newCurrentFilter(filter);
    }
...
//            setBackgroundColor(Color.BLACK);
    ...
    public void setHandleTouchEvent(boolean enable) {
        mHandleTouchEvent = enable;
    }
