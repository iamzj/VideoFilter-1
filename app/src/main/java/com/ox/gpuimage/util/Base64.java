...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    /**
     * 用合法字符替换Base64生成的非法的Url参数字符串
     * @return
     */
    public static String replaceIllegalUrlString(String str) {
        if (str != null) {
            str = str.replaceAll("=", ":")
                    .replaceAll("/", "_")
                    .replaceAll("\\+", "-");;
    ...
    /**
     * 还原Base64生成的非法的Url参数字符串
     * @return
     */
    public static String revertIllegalUrlString(String str) {
        if (str != null) {
            str = str.replaceAll(":", "=")
                    .replaceAll("_", "/")
                    .replaceAll("-", "+");;
